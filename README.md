# BrandHive Studio WhatsApp AI Agent

A full-stack WhatsApp AI agent built with Next.js for BrandHive Studio. It receives messages via the Meta WhatsApp Business API, generates AI replies using OpenRouter grounded in BrandHive's authoritative service/pricing/FAQ knowledge base, and provides a real-time dashboard to view and manage all conversations. It also has `Human` & `AI` reply mode
...
4. Give it a name (e.g. "BrandHive Studio AI Agent") and click **Create**
...
1. Clone this repo and install dependencies:
   ```bash
   git clone https://github.com/BrandHiveStudio/BrandHive-WhatsApp-AI-Agent.git
   cd BrandHive-WhatsApp-AI-Agent
   npm install
   ```
