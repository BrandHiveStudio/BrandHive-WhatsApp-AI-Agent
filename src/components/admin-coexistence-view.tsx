...
interface AdminCoexistenceViewProps {
  appId?: string;
  configId?: string;
}
...
export function AdminCoexistenceView({
  appId = process.env.NEXT_PUBLIC_META_APP_ID || "1395774185211806",
  configId = process.env.NEXT_PUBLIC_META_WHATSAPP_EMBEDDED_SIGNUP_CONFIG_ID || "",
}: AdminCoexistenceViewProps) {
